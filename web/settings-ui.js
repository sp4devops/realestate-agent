...
async function createBackup(){
 ...
 try{
  ...
  const fileName=`phone-copy-${new Date().toISOString().slice(0,10)}.json`;
...
async function restoreBackup(){
 ...
 try{
  ...
  document.querySelector('[data-testid="restore-password"]').value='';status.textContent='Backup restored safely. Reloading what is saved on this phone…';setTimeout(()=>location.reload(),0);
