(function () {
  ...
  function identityCandidates(parsed){
    ...
    return people.filter(person=>phone?[person.primaryPhone,...(person.alternatePhones||[])].some(value=>normalize(value)===phone):name&&normalizeName(person.name)===name);
  }
