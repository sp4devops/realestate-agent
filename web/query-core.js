...
function interpret(input){
 ...
 const stop=new Set(['show','find','me','all','the','in','at','for','under','below','max','budget','is','up','to','properties','property','people','person','contact','contacts','matches','match','owner','buyer','buyers','land','plot','site','house','home','flat','apartment','buy','sale','sell','rent','rental']);
