...
function interpret(input){
 ...
 const intent=/\b(?:rent|rental|vaadagai|vadagai)\b/i.test(lower)?'rent':/\b(?:buy|buyer|purchase|want|need)\b/i.test(lower)?'buy':/\b(?:sale|sell|seller|selling)\b/i.test(lower)?'sale':null;
